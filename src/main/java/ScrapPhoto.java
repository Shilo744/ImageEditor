...
import java.net.URL;
    ...
    public class ScrapPhoto{
        ...
        private final String FACEBOOK_WEB_PATH = "https://www.facebook.com/";
        //שינוי נתיב בהתאם
        private final String CURRENT_CHROME_DRIVER =chromeDriverLocationNachshon;
        ...
        public void usePhoto(String username) {
            ...
            final String FACEBOOK_URL = FACEBOOK_WEB_PATH;
            try {
